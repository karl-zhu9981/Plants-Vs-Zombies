...
public class Main extends JFrame implements MouseListener, ActionListener{//Our main class. Checks for actions and keys
    ...
    public Main(){
    	...
    	setSize(1100,700);//Size of our screen
		myTimer = new Timer(10,this);
		myTimer.start();

		menuPic = new ImageIcon("menuPic.jpg").getImage();//Background image
		menuPic = menuPic.getScaledInstance(1100,700,Image.SCALE_SMOOTH);
...
class GamePanel extends JPanel implements MouseListener{
	...
	public GamePanel(){
		...
		mapPic = map.getScaledInstance(1100,700,Image.SCALE_SMOOTH);
		//setSize(800,600);
		addMouseListener(this);
	}
	@Override
